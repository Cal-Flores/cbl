...
def seed_fighters():
    ...
    fighter_42 = Fighter(id=42,name='Jordan Burroughs', nickname='JB', prof_img='../../../images/jb.png',body_img='../../../images/jbbody.png', weight='157', team_name='Colony Buccaneers', tour_win=13, tour_loss=3, points=55)
