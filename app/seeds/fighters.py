...
def seed_fighters():
    ...
    fighter_21 = Fighter(id=21,name='Deiveson Figueiredo', nickname='', prof_img='',body_img='', weight='135', team_name='Allen Chiefs')
    ...
    fighter_95 = Fighter(id=59,name='Arman Tsarukyan', nickname='', prof_img='https://fight.ru/wp-content/uploads/2020/07/arman-tsarukyan.png',body_img='', weight='157', team_name='A.M Consolidated Steelers')
    ####################### Welter ###########################
