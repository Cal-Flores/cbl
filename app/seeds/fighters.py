...
def seed_fighters():
    ...
    ###################### LIGHT #############################
    fighter_39 = Fighter(id=39,name='Charles Oliviera', nickname='', prof_img='https://dmxg5wxfqgb4u.cloudfront.net/2021-06/67583%252Fprofile-galery%252Fprofile-picture%252FOLIVEIRA_CHARLES_BeltMock.png?VersionId=null&itok=ajikbvtD',body_img='', weight='157', team_name='Grapevine Falcons')
