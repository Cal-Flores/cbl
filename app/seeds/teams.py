...
def seed_teams():
    ...
    team_15 = Team(id=15,name='Allen Chiefs', logo_img='https://res.cloudinary.com/nflleague/image/private/f_auto/league/ujshjqvmnxce8m4obmvs', background_img='https://res.cloudinary.com/nflleague/image/private/f_auto/league/ginftk4rv6gflay6mwur',conf='AFC', divison='East')
