...
def seed_teams():
    ...
    team_10 = Team(id=10,name='A.M Consolidated Steelers', logo_img='https://res.cloudinary.com/nflleague/image/private/f_auto/league/xujg9t3t4u5nmjgr54wx', background_img='https://res.cloudinary.com/nflleague/image/private/f_auto/league/s2ugk74phksrnbla46e7',conf='AFC', divison='North')
